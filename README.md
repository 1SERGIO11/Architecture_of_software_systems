...
**Требования:**
 - пользователи будут размещать свой заказ, затем им будет предоставлено время, чтобы забрать свой сэндвич, с указанием дороги до магазина (который должен интегрироваться с несколькими внешними картографическими службами, которые включают информацию о дорожном движении) если магазин предлагает услугу доставки, отправьте водителя с сэндвичем к пользователю
